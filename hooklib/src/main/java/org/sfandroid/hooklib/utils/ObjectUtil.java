...
public class ObjectUtil {
     ...
     * 空类名值,唯一不重复即可
     */
    public static final String NULL_NAME = "30fd3a6b-c5ff-5c3a-b628-dedac58832db";
    ...
    /**
     * 将{@link Null}对象都认为是null,方便某一刻区分真正的null
     *
     * @param obj 对象
     * @return 是否为空对象
     */
    ...
    /**
     * 将{@link Null}类型认为null,方便区分默认值是否为null
     *
     * @param cls 类型
     * @return 为null返回true
     */
    public static boolean isNullClass(Class<?> cls) {
        return cls == null || cls == Null.class;
    }

    public static boolean isNullClasses(Class<?>[] classArray) {
        if (classArray == null) {
            return true;
        }
